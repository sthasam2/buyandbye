...
from .views.category_views import CategoryDetailView, CategoryListView, load_subCat
...
from .views.search_views import AdvancedSearchListView, SearchItemListView
...
urlpatterns = [
    ...
    path("recommended/", RecommendedItemListView.as_view(), name="recommended-items"),
    ...
    path(
        "search/advanced",
        AdvancedSearchListView.as_view(),
        name="advanced_search_results",
    ),
    path(
        "ajax/load_subcategory/",
        category_views.load_subCat,
