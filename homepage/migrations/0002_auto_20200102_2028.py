# Generated by Django 3.0 on 2020-01-02 14:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='item',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default_currency='NPR', max_digits=10),
        ),
        migrations.AddField(
            model_name='item',
            name='price_currency',
        ...
        migrations.AlterField(
            model_name='category',
            name='name',
            field=models.CharField(choices=[('Real Estate', 'Real Estate'), ('Automobiles', 'Automobiles'), ('Furniture', 'Furniture'), ('Jobs', 'Jobs'), ('Computer', 'Computer'), ('Mobiles', 'Mobiles'), ('Books', 'Books'), ('Electronics', 'Electronics'), ('Cameras', 'Cameras'), ('Music Instruments', 'Music Instruments'), ('Pets', 'Pets'), ('Sports and Fitness', 'Sports and Fitness'), ('Services', 'Services'), ('Jobs', 'Jobs'), ('Clothing', 'Clothing')], max_length=100),
        ),
        migrations.AlterField(
            model_name='item',
            name='image',
            field=models.ImageField(default='default.jpg', upload_to='item_pics/<slug:username>'),
        ),
        migrations.AlterField(
            model_name='item',
            name='slug',
