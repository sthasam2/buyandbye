# Generated by Django 3.0 on 2020-01-05 15:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Apparel&Accessories', 'Apparel and Accessories'), ('Automobiles', 'Automobiles'), ('Beauty&Health', 'Beauty and Health'), ('Books', 'Books'), ('Business&Industry', 'Business and Industry'), ('Computers&Peripherals', 'Computers and Peripherals'), ('Electronics', 'Electronics'), ('Events&Happenings', 'Events and Happenings'), ('Home,Furnishing&Appliances', 'Home, Furnishing and Appliances'), ('Jobs', 'Jobs'), ('Mobiles&Accessories', 'Mobiles and Accesories'), ('MusicInstruments', 'Music Instruments'), ('Pet&PetCare', 'Pet and Pet Care'), ('RealEstate', 'Real Estate'), ('Sports&Fitness', 'Sports and Fitness'), ('Services', 'Services'), ('Toys&VideoGames', 'Toys and Video Games'), ('Torism&Tours', 'Tourism and Tours'), ('Others', 'Others')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='NPR', max_digits=10)),
